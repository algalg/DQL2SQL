...
// $Rev: 52393 $
// File generated on 10.11.2015 10:39:11 from Type Library described below.
...
// *********************************************************************//
  IDQLProcessor = interface(IDispatch)
    ...
    function ConvertDqlToSql(const SQL: WideString; out TableName: WideString): WideString; stdcall;
  end;
...
// *********************************************************************//
  IDQLProcessorDisp = dispinterface
    ['{4DE4873E-3E46-4D57-A095-014A15B82EC6}']
    function ConvertDqlToSql(const SQL: WideString; out TableName: WideString): WideString; dispid 201;
  end;
